...
var submitcity = $('#search')

// if submit  button is clicked.........
let submitclicked = submitcity.on('click', function (event) {
...
console.log(localStorage.getItem('savedlink'));
var searchdata = JSON.parse(localStorage.getItem('savedlink'));
console.log(searchdata[1])
for (i = 0; i < searchdata.length; i++) {
    var append = $('#tops')
    var searchistory = $('<button>');
